...
public:
  ...
  const BoundingBox& getBoundingBoxOfMesh(gims::ui32 meshIdx) const;
  ...
  void addToCommandListBoundingBox(const Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& commandList,
                                   const gims::f32m4 transformation, gims::ui32 modelViewRootParameterIdx,
                                   gims::ui32 materialConstantsRootParameterIdx, gims::ui32 srvRootParameterIdx);

  void addToCommandListDepth(const Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& commandList,
                             const Microsoft::WRL::ComPtr<ID3D12DescriptorHeap>&      depthSrvDescriptorHeap,
                             const gims::ui32                                         srvRootParameterIdx);

  void addToCommandListPost(const Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& commandList,
